...
The DevOps open hack event is designed to foster learning via implementing DevOps practices with a series of challenges. Simple change to create a PR without an associated issue number. 
